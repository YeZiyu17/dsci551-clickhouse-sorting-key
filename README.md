...
This project implements the application as a SQL-based analytical workload. The `demo.sql` file represents the application operations of a lightweight analytics dashboard backend, including recent-window revenue, country aggregation, and daily trend analysis.
